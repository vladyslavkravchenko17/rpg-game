...
import main.java.game.UI.InventorySlotType;
import main.java.game.item.Item;
import main.java.game.item.ItemType;
import main.java.game.item.armor.Armor;
import main.java.game.item.armor.ArmorType;
...
import main.java.game.item.weapon.Weapon;
