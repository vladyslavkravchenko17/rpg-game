...
public class Player extends Entity {
    ...
    public Player(GamePanel gamePanel, KeyHandler keyHandler) {
        ...
        setDefaultValues();
        setDefaultPosition();
        setImages("src/resources/player/move/body/");
        setHairImages("src/resources/player/move/hair/");
        setEyesImages("src/resources/player/move/eyes/");
        setAttackImages("src/resources/player/attack/");
    }
    ...
    private void attack() {
        ...
        if (spriteCounter <= 3) {
            ...
            switch (direction) {
                ...
                case LEFT, UP_LEFT, DOWN_LEFT -> worldX -= weapon.attackArea.width;
                case RIGHT, UP_RIGHT, DOWN_RIGHT -> worldX += weapon.attackArea.width;
            }
            solidArea.width = weapon.attackArea.width;
            solidArea.height = weapon.attackArea.height;
